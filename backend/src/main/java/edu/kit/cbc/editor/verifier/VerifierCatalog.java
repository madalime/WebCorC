 ...
 * unavailable and why; {@code null} — and omitted from the JSON — when every Verifier loaded.
 * The frontend forwards it verbatim and performs no reasoning about it. Not composed yet:
 * until registered Verifiers are fetched over the Verifier API it is always {@code null}.
 *
